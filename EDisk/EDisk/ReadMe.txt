================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : EDisk Project Overview
===============================================================================

The application wizard has created this EDisk application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your EDisk application.
...
EDisk.h
    ...
    project specific headers and declares the CEDiskApp application class.
...
EDiskDlg.h, EDiskDlg.cpp - the dialog
    These files contain your CEDiskDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named EDisk.pch and a precompiled types file named StdAfx.obj.

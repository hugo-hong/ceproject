...
*
**/
MRESULT     SubtitleCtrl_OpenSubtitle(HSUBTITLECTRL hSubtitleCtrl);

#if ENABLE_ISDBT

/**
*    @brief set default language for Close Caption of ISDBT
*
*    @param[in]     hSubtitleCtrl  subtitle control handle
*    @param[in]     u4DefaultLang  default language for Close Caption 
*    
*    @return    MRESULT  define in msdk_error.h
*               
*
